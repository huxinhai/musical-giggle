 ...
 */
export const getExamDetail = (params: ExamDetailParams): Promise<ApiResponse<ExamDetailResponse>> => 
  post<ApiResponse<ExamDetailResponse>>('/userService/getExamDetail', params);
