 ...
 */
export const getSupportTimeFrame = (data: Record<string, any> = {}): Promise<ApiResponse<getSupportTimeFrameResponse[]>> =>
    post<ApiResponse<getSupportTimeFrameResponse[]>>('/dataService/getSupportTimeFrame', data);
