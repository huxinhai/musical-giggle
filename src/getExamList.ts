 ...
 */
export const getExamList = (params: Pagination): Promise<ApiResponse<ExamListResponse>> => {
  return post<ApiResponse<ExamListResponse>>('/userService/getExamList', params);
};
