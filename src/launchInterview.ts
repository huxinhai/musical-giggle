 ...
 */
export const launchInterview = async (data: LaunchInterviewData): Promise<ApiResponse<launchInterviewResponse>> => post<ApiResponse<launchInterviewResponse>>('/userService/launchInterview', data)