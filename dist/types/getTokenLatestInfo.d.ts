 ...
 */
export declare const getTokenLatestInfo: (data: GetTokenLatestInfoParams) => Promise<ApiResponse<GetTokenLatestInfoResponse>>;
export {};
//# sourceMappingURL=getTokenLatestInfo.d.ts.map